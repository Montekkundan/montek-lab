...
function Scene() {
  ...
  return (
    <>
      <Html zIndexRange={[-1, -10]} prepend fullscreen className={styles.html_container}>
      <div ref={(el) => setDomEl(el)} className={styles.dom_element}>
      
      <p style={{ margin: 0, padding: 0, width: '100%', textAlign: 'center' }}>What I cannot create</p>
      <p style={{ margin: 0, padding: 0, width: '100%', textAlign: 'center' }}>I do not understand</p>
</div>
